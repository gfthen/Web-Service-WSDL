...
public class JaxWebServiceProvider implements InitializingBean {
    ...
    Log LOJJER = LogFactory.getLog(getClass());
    ...
    public JaxWebServiceProvider(String endpoint, String serviceInterface, String serviceImplementation) {
	...
	LOJJER.info("WEB SERVICE PROVIDER HAS BEEN INITIALIZED: " + Calendar.getInstance().getTime());
    }
}
